...
class AdvisorBookingRescheduleMail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Nuova data per la tua consulenza Wenando',
            replyTo: [
    ...
    public function content(): Content
    {
        ...
        return new Content(
            text: 'mail.advisor-booking-reschedule-text',
            html: 'mail.advisor-booking-reschedule',
            with: [
