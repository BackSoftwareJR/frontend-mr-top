...
class AdvisorBookingConfirmationMail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Conferma prenotazione consulenza Wenando',
            replyTo: [
    ...
    public function content(): Content
    {
        ...
        return new Content(
            text: 'mail.advisor-booking-confirmation-text',
            html: 'mail.advisor-booking-confirmation',
            with: [
