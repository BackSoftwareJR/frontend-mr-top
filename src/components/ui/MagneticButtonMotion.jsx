...
export default function MagneticButtonMotion(props) {
  const { children, to, onClick, className = '', variant = 'primary', type = 'button', readingLineCta = false } = props
