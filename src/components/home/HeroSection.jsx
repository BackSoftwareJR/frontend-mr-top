...
function HomeNav() {
  return (
    ...
    >
      <nav className="flex w-full max-w-5xl items-center justify-between gap-4 rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-2.5 shadow-sm backdrop-blur-2xl">
